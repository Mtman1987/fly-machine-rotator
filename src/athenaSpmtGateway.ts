    ...
    const proxied = httpRequest({ hostname: "127.0.0.1", port: internalPort, method: "GET", path: "/", headers }, (upstream) => {
      ...
      upstream.on("end", () => {
        ...
        html = html
          ...
          .replace('<a href="#codex-jobs">Stella Coder</a>', '<a href="/athena">Stella Coder IDE</a>');
...
function renderIde(jobs: PublicCodexJob[], references: CodeReference[], connections: Connection[]) {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Stella Coder IDE</title>
<style>
...
<header class="topbar"><div class="brand"><span class="orb"></span><span>Stella Coder IDE</span></div><nav class="nav"><a href="/athena">Coder</a><a href="/rotator">Rotator controls</a><a href="/mountainview">MountainView</a><a href="https://spmt.live/docs">SPMT SDK</a><a href="/logs/errors.txt">Error log</a></nav></header>
