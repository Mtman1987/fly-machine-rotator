...
function renderHome(adminName: string): string {
  const cards = [
    ...
    ["Stella Coder", "/athena", "Create isolated coding jobs, inspect diffs and checks, and publish approved draft pull requests.", "Engineering"],
